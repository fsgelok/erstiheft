...
Unser Institut besitzt fachliche Schwerpunkte auf den Gebieten der Angewandten Landschaftsökologie/Ökologische Planung, Biodiversität/Ökosystemforschung, Bodenökologie/Landnutzung und Klimatologie, Ökohydrologie/Stoffkreisläufe, Tierökologie/multitrophe Interaktionen sowie Waldökologie/ Forst- und Holzwirtschaft. Dies sind auch die sechs Arbeitsgruppen am ILÖK. Im Vergleich zur Geoökologie, die stärker abiotisch ausgerichtet ist, gibt es bei der Landschaftsökologie in etwa ein Gleichgewicht zwischen abiotischem und biotischem Themenspektrum (biotisch = belebte Natur; abiotisch = unbelebte Natur z. B. Gestein, Wasser-Chemie, etc.).
...
\begin{longtable}{p{0.75\textwidth} p{0.1\textwidth} p{0.1\textwidth}}
 & Typ & ECTS \\ 
\textbf{B1 Geologie/Geomorphologie} & & \textbf{5}\\ 
Einführung in die Geologie und -morphologie & V & 3\\
Gesteinskunde & Ü & 2\\
& &\\
...
Mindestens 8 Tage plus begleitendes Seminar (Wahlpflicht) oder & Exk. & 8\\
...
Grundlagen des Projektmanagements & Ü & 2\\
Praxisprojekt & P & 2\\
Begleitseminar & S & 1\\
&&\\
...
Übung Wasser- und Biogeochemie & Ü & 3 \\
...
&&\\
\textbf{B16 Geostatistik} && \textbf{5}\\
Geostatistik & V & 2\\
Übung Geostatistik & Ü & 3\\
&&\\
\textbf{B17 Geoinformatik} && \textbf{10}\\
Einführung in die Geoinformatik & V & 2\\
Geoinformatik Übung & Ü & 3\\
Angewandte Karthographie & Ü & 5\\
&&\\
\textbf{B18 Methoden der Landschaftserfassung}&&\textbf{5}\\
...
&&\\
\textbf{B20 Ergänzungsmodul II} && \textbf{5}\\
Verschiedene Veranstaltungen & & 5\\
&&\\
\textbf{B21 Ergänzungmodul III} && \textbf{5}\\
möglicher Ersatz für B12 (Allgemeine Studien II (Projektmanagement))\\
Verschiedene Veranstaltungen & & 5\\
&&\\
\textbf{B22 Raum- und Umweltplanung}&&\textbf{10}\\
...
&&\\
\textbf{B23 Angewandte Landschaftsökologie} && \textbf{10}\\
Studienprojekt & & 10\\
&&\\
\textbf{B24 Berufsorientiertes Praktikum} & & \textbf{10}\\
&&\\
\textbf{B25 Wissenschaftliches Arbeiten} & & \textbf{5}\\
Projekt und Teamarbeit & S & 1 \\
Projekt-/Studienarbeit && 4\\
&&\\
...
Für Landschaftsökologen gibt es kein einheitliches Berufsbild, wie zum Beispiel für Juristen oder Lehrer. Die Einsatzmöglichkeiten auf dem Arbeitsmarkt sind vielfältig, einige sind bei
\begin{itemize}
  ...
  \item{Forschung bei verschiedenen Instituten}
\end{itemize}
...
\textbf{Es macht einfach Spaß, Landschaftsökologie zu studieren!}
